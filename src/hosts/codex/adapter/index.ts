...
import { DefaultCodexCommandRunner, type CodexCommandRunner } from "./cli.js";
import {
...
export class CodexAdapter implements HostAdapter {
  ...
  constructor(private readonly runner: CodexCommandRunner = new DefaultCodexCommandRunner()) {}
  ...
  async executeAssignment(
    ...
    let execution;
    try {
      execution = await this.runner.runExec({
